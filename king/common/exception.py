...
class MissingCredentialError(KingException):
    msg_fmt = _("Missing required credential: %(required)s")


class AuthorizationFailure(KingException):
    msg_fmt = _("Authorization failed.")


class NotAuthenticated(KingException):
    msg_fmt = _("You are not authenticated.")


class Forbidden(KingException):
...
class KingExceptionWithPath(KingException):
    ...
    def __init__(self, error=None, path=None, message=None):
        ...
        super(KingExceptionWithPath, self).__init__(
...
class StackValidationFailed(KingExceptionWithPath):
    pass


class InvalidSchemaError(KingException):
    msg_fmt = _("%(message)s")
...
class InvalidGlobalResource(KingException):
    msg_fmt = _("There was an error loading the definition of the global "
                "resource type %(type_name)s.")


class ResourceTypeUnavailable(KingException):
    error_code = '99001'


class InvalidBreakPointHook(KingException):
    msg_fmt = _("%(message)s")


class InvalidRestrictedAction(KingException):
    msg_fmt = _("%(message)s")


class ResourceNotAvailable(KingException):
    msg_fmt = _("The Resource (%(resource_name)s) is not available.")


class ClientNotAvailable(KingException):
...
class ResourceFailure(KingExceptionWithPath):
...
class NotSupported(KingException):
    msg_fmt = _("%(feature)s is not supported.")


class ResourceActionNotSupported(KingException):
    msg_fmt = _("%(action)s is not supported for resource.")


class ResourceActionRestricted(KingException):
    msg_fmt = _("%(action)s is restricted for resource.")


class ResourcePropertyConflict(KingException):
...
class ResourcePropertyDependency(KingException):
    msg_fmt = _('%(prop1)s cannot be specified without %(prop2)s.')


class ResourcePropertyValueDependency(KingException):
    msg_fmt = _('%(prop1)s property should only be specified '
                'for %(prop2)s with value %(value)s.')


class PropertyUnspecifiedError(KingException):
...
class ResourceUnknownStatus(KingException):
...
class ResourceInError(KingException):
