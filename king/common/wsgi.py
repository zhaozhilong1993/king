...
api_opts = [
    ...
    cfg.PortOpt('bind_port', default=9000,
    ...
    cfg.IntOpt('workers', default=0,
               help=_("Number of workers for King service. "
...
api_group = cfg.OptGroup('king_api')
...
class Request(webob.Request):
    ...
    def best_match_language(self):
        ...
        if not self.accept_language:
            return None
        all_languages = i18n.get_available_languages('king')
...
class Resource(object):
    ...
    def __call__(self, request):
        ...
        try:
            ...
            http_exc = translate_exception(err, request.best_match_language())
            raise exception.HTTPExceptionDisguise(http_exc)
        except exception.KingException as err:
        ...
        # return unserializable result (typically an exception)
            ...
            # Here we should get API exceptions derived from KingAPIException
...
def translate_exception(exc, locale):
    ...
    if isinstance(exc, exception.KingException):
