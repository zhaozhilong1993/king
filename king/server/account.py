...
class AccountListener(service.Service):
    ...
    def __init__(self, host, engine_id, thread_group_mgr):
        super(AccountListener, self).__init__()
...
class AccountService(service.Service):
    ...
    def start(self):
        ...
        super(AccountService, self).start()
    ...
    def _stop_rpc_server(self):
        ...
        try:
            ...
            LOG.info(_LI("Account service is stopped successfully"))
    ...
    def stop(self):
        ...
        super(AccountService, self).stop()
